def validate_guess(guess, word_length=5):
    ...
    Examples
    --------
    >>> validate_guess('heart')
    True
    >>> validate_guess('CHAIR')
    False
    >>> validate_guess('bed')
    False
    """
...
def check_guess(secret_word, guess):
    ...
    Examples
    --------
    >>> check_guess('dream', 'dream')
    [('d', 'green'), ('r', 'green'), ('e', 'green'), ('a', 'green'), ('m', 'green')]
    >>> check_guess('front', 'climb')
    [('c', 'gray'), ('l', 'gray'), ('i', 'gray'), ('m', 'gray'), ('b', 'gray')]
    >>> check_guess('cloud', 'drove')
    [('d', 'yellow'), ('r', 'gray'), ('o', 'green'), ('v', 'gray'), ('e', 'gray')]
    """
